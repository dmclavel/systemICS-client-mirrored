            	...
            	<Segment padded="very">
            		<Header as="h2">Edit {this.props.coursecode} {this.props.section} </Header>
		            			...
		            			<Form.Input
										...
										<Form.Group>
											<Form.Dropdown search selection label="Status" placeholder="Choose status" options={statusOptions} value={status} onChange={this.handleDropdownChange} width={4} />
											<Form.Input width={2} min={0} type="number" label="Capacity" placeholder="Max Capacity" name="max_capacity" value={max_capacity} onChange={this.handleChange} width={4}/>
											<Form.Input width={2} min={0} max={max_capacity} type="number" label="No. of Students" placeholder="No. of Students" name="no_of_students" value={no_of_students} onChange={this.handleChange} width={3}/>
