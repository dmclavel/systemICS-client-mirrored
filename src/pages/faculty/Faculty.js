...
class Faculty extends Component {
  ...
  componentDidMount = () => {
    ...
    socket.on(
      'view_all_active_faculty_teaching_load',
      returnValueFromServer => {
          ...
          <Grid>
            ...
            <Grid.Row>
              ...
              <Grid.Column width={8}>
                <Grid.Row>
                  <Input
                    fluid
                    action={
                      <Button icon="search" onClick={this.handleCourseClick} />
                    }
                    placeholder="Search..."
                  />
              ...
              <Grid.Column width={5}>
                ...
                <Input
                  fluid
                  action={<Button icon="search" onClick={this.handleClick} />}
                  placeholder="Search..."
                />
